...
class TopFamMovies extends StatefulWidget {
  final int ind;
   TopFamMovies (this.ind);
  @override
  _TopFamMoviesState createState() => _TopFamMoviesState();
}

class _TopFamMoviesState extends State<TopFamMovies> {

  List data;
   Future<List> getdata() async {
    var res =
        await http.get(Uri.parse('https://api.themoviedb.org/3/discover/movie?api_key=54a91f8f6f10791019cbee06394e04a8&with_genres=10751&sort_by=vote_count.desc'), );
