...
class TopRomMovies extends StatefulWidget {
  final int ind;
   TopRomMovies (this.ind);
  @override
  _TopRomMoviesState createState() => _TopRomMoviesState();
}

class _TopRomMoviesState extends State<TopRomMovies> {

  List data;
   Future<List> getdata() async {
    var res =
        await http.get(Uri.parse('https://api.themoviedb.org/3/discover/movie?api_key=54a91f8f6f10791019cbee06394e04a8&with_genres=10749&sort_by=vote_count.desc'), );
  ...
  Widget build(BuildContext context) {
    return  FutureBuilder<List>(
      ...
      onTap: (){
        ...
        Navigator.push(
    context,
    MaterialPageRoute(builder: (context) => TestMovie(data[widget.ind]["id"])),
  );
      },
    child: InkWell(
      child: Stack(
