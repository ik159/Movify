...
class TestMovie extends StatefulWidget {
  final int movieid;
  TestMovie(this.movieid);
  @override
  _TestMovieState createState() => _TestMovieState();
}

class _TestMovieState extends State<TestMovie>
                    ...
                    Container(
                      ...
                      child: Stack(
                        children: <Widget>[
                          ...
                          Positioned(
                            top: screenheight * 0.3176,
                            left: screenwidth * 0.4640,
                            right: screenwidth * 0.0598,
                            child: FutureBuilder(
                              future: getdatagenre(),
                          ...
                          Positioned(
                            top: screenheight * 0.3729,
                            left: screenwidth * 0.464,
                            right: screenwidth * 0.0449,
                            child: Container(
                              height: 29,
                          ...
                          Positioned(
                            bottom: screenheight * (6/724),
                            left: screenwidth *(150/334),
                            right: 0,
                            child: Row(
