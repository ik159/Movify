...
class TVShowsDetails extends StatefulWidget {
  final int movieid;
  TVShowsDetails(this.movieid);
  @override
  _TVShowsDetailsState createState() => _TVShowsDetailsState();
}
...
class _TVShowsDetailsState extends State<TVShowsDetails> {
  ...
  checkinitMovie() {
    ...
    dbHelper.checkMovie(1, widget.movieid).then((value) {
  ...
  Future<DetailsById> getData() async {
    final response = await http.get(
        "https://api.themoviedb.org/3/tv/${widget.movieid}?api_key=54a91f8f6f10791019cbee06394e04a8&language=en-US&append_to_response=videos");
  ...
  Future<List> getdataone() async {
    var res = await http.get(
      Uri.parse(
          'https://api.themoviedb.org/3/tv/${widget.movieid}/similar?api_key=54a91f8f6f10791019cbee06394e04a8&language=en-US&page=1'),
    );
  ...
  Future<List> getdatagenre() async {
    var res = await http.get(
      Uri.parse(
          'http://api.themoviedb.org/3/tv/${widget.movieid}?api_key=54a91f8f6f10791019cbee06394e04a8&append_to_response=videos'),
    );
  ...
  Future<List> getdatacast() async {
    var res = await http.get(
      Uri.parse(
          'https://api.themoviedb.org/3/tv/${widget.movieid}/credits?api_key=54a91f8f6f10791019cbee06394e04a8'),
    );
  ...
  Future<List> getmedia() async {
    var res = await http.get(
      Uri.parse(
          'https://api.themoviedb.org/3/tv/${widget.movieid}/images?api_key=54a91f8f6f10791019cbee06394e04a8'),
    );
                      ...
                      child: Column(
                        children: [
                          ...
                          isFav.toString() == "1"
                              ? GestureDetector(
                                  onTap: () {
                                    dbHelper.delete(1, widget.movieid);
                                    checkinitMovie();
                                  },
                                  child: Row(
                                    mainAxisAlignment: MainAxisAlignment.center,
                              ...
                              : GestureDetector(
                                  onTap: () {
                                    addtoFavs(
                                        widget.movieid, 1, widget.movieid);
                                    checkinitMovie();
                                  },
                                  child: Row(
                                    mainAxisAlignment: MainAxisAlignment.center,
