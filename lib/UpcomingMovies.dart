...
class NowPlayingUS extends StatefulWidget {
  final int ind;
  NowPlayingUS(this.ind);
  @override
  _NowPlayingUSState createState() => _NowPlayingUSState();
}

class _NowPlayingUSState extends State<NowPlayingUS> {
  List data;
  Future<List> getdata() async {
    var res = await http.get(
      Uri.parse(
          'https://api.themoviedb.org/3/movie/now_playing?api_key=54a91f8f6f10791019cbee06394e04a8&region=US'),
    );
            ...
            child: InkWell(
              child: Stack(
                children: <Widget>[
                  ...
                  Container(
                      margin:
                          EdgeInsets.only(right: 25.0, left: 15.0, top: 15.0),
                      height: 30.0,
                      decoration: BoxDecoration(
