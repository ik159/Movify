...
class TopSciFiMovies extends StatefulWidget {
  final int ind;
   TopSciFiMovies (this.ind);
  @override
  _TopSciFiMoviesState createState() => _TopSciFiMoviesState();
}

class _TopSciFiMoviesState extends State<TopSciFiMovies> {

  List data;
   Future<List> getdata() async {
    var res =
        await http.get(Uri.parse('https://api.themoviedb.org/3/discover/movie?api_key=54a91f8f6f10791019cbee06394e04a8&with_genres=878&sort_by=vote_count.desc'), );
